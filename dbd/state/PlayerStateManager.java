...
public class PlayerStateManager {
    ...
    public void handleHit(Player p, Player killer) {
        ...
        if (current == PlayerState.HEALTHY) {
            ...
            // Wywołanie customowego eventu dla Skripta
            org.bukkit.Bukkit.getPluginManager().callEvent(new pl.dbd.skript.SkriptEvents.PlayerInjuredEvent(p, killer));
            ...
            // Wywołanie customowego eventu dla Skripta
            org.bukkit.Bukkit.getPluginManager().callEvent(new pl.dbd.skript.SkriptEvents.PlayerDownedEvent(p, killer));
        }
    }
