...
public class DBDPlugin extends JavaPlugin {
    ...
    private pl.dbd.punishment.GameBanManager gameBanManager;
    private pl.dbd.punishment.QuitPenaltyManager quitPenaltyManager;
    private pl.dbd.movement.ScratchMarkManager scratchMarkManager;
    ...
    private pl.dbd.game.TerrorRadiusManager terrorRadiusManager;
    ...
    private pl.dbd.combat.StunManager stunManager;
    ...
    public void onEnable() {
        ...
        this.gameBanManager = new pl.dbd.punishment.GameBanManager(this);
        this.quitPenaltyManager = new pl.dbd.punishment.QuitPenaltyManager(this);
        this.scratchMarkManager = new pl.dbd.movement.ScratchMarkManager(this);
        ...
        this.stunManager = new pl.dbd.combat.StunManager(this);
        this.terrorRadiusManager = new pl.dbd.game.TerrorRadiusManager(this);
        ...
        if (Bukkit.getPluginManager().getPlugin("Skript") != null) {
            try {
                ch.njol.skript.Skript.registerAddon(this).loadClasses("pl.dbd.skript");
                pl.dbd.skript.SkriptEvents.register();
            } catch (java.io.IOException e) {
                getLogger().severe("Nie udalo sie zaladowac klas Skripta: " + e.getMessage());
            }
        }
    ...
    private void registerCommands() {
        ...
        safeRegister("sklepzadusze", new ShopCommand(this));
        ...
        safeRegister("gameban", new GameBanCommand(this));
        safeRegister("gameunban", new GameUnbanCommand(this));
        safeRegister("dbdstate", new pl.dbd.commands.StateCommand(this));
    ...
    private void registerTabCompleters() {
        ...
        String[] cmdsWithTab = {
                ...
                "gotowy", "niegotowy", "sklepzadusze", "shopadmin", "ekwipunekadmin", "trycrawl",
                "gameban", "gameunban", "dbdstate"
        };
    ...
    private void registerListeners() {
        ...
        getServer().getPluginManager().registerEvents(quitPenaltyManager, this);
    ...
    public pl.dbd.punishment.GameBanManager getGameBanManager() {
        return gameBanManager;
    }

    public pl.dbd.punishment.QuitPenaltyManager getQuitPenaltyManager() {
        return quitPenaltyManager;
    }

    public pl.dbd.movement.ScratchMarkManager getScratchMarkManager() {
        return scratchMarkManager;
    }

    public pl.dbd.combat.StunManager getStunManager() {
        return stunManager;
    }
    ...
    public pl.dbd.game.TerrorRadiusManager getTerrorRadiusManager() {
